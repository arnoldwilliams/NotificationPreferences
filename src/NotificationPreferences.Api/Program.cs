...
builder.Services.AddDbContext<NotificationPreferencesDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("NotificationPreferences")));
